  ...
  set :application,     "arborguide_website"
  set :repo_url,        "git@github.com:dschmura/arborguide_website.git"
  set :user,            'deployer'
  ...
  set :deploy_to,       "/home/#{fetch(:user)}/apps/arborguide_website"
  # Puma specific settings
  set :puma_bind,       "unix://#{shared_path}/tmp/sockets/arborguide_website-puma.sock"
